...
import { useCurrentTab, formatRelativeTime } from '@/shared/lib';
      ...
      <View className="flex-row items-start">
        ...
        <View className="flex-1">
          ...
          <View className="flex-row items-center mb-1">
            <Text className="text-base font-semibold text-foreground dark:text-dark-foreground flex-shrink" numberOfLines={1}>
              {map.name}
            </Text>
