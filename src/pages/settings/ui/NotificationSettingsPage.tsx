...
export function NotificationSettingsPage() {
  ...
  // 設定更新ハンドラー
  const handleToggle = (key: 'push_enabled' | 'like_enabled' | 'comment_enabled' | 'follow_enabled' | 'system_enabled', value: boolean) => {
    if (!settings) return;
  ...
  const isAllDisabled = !settings.push_enabled || isPending;
