...
| secret | text |  | true |  |  |  |
| phone | text |  | true |  |  |  |
| last_challenged_at | timestamp with time zone |  | true |  |  |  |
| web_authn_credential | jsonb |  | true |  |  |  |
| web_authn_aaguid | uuid |  | true |  |  |  |
| last_webauthn_challenge_data | jsonb |  | true |  |  | Stores the latest WebAuthn challenge data including attestation/assertion for customer verification |
...
| mfa_factors_last_challenged_at_key | UNIQUE | UNIQUE (last_challenged_at) |
