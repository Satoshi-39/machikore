...
-- Insert 5 spots (non-premium default)
...
select is(
  ...
  5::bigint,
  'non-premium can insert up to 5 spots'
);

select throws_ok($$
  insert into public.user_spots (id, user_id, map_id, description, latitude, longitude, is_public)
  values ('71000000-0000-0000-0000-000000000031', tests.get_supabase_uid('limit_user1'), '70000000-0000-0000-0000-000000000001', 'spot 6', 35.5, 139.5, true)
$$, '42501', null, 'non-premium cannot insert 6th spot');

select is(
  (select count(*) from public.user_spots where map_id = '70000000-0000-0000-0000-000000000001')::bigint,
  5::bigint,
  'spot count remains 5 after failed insert'
);
reset role;
...
select lives_ok($$
  insert into public.user_spots (id, user_id, map_id, description, latitude, longitude, is_public)
  values ('71000000-0000-0000-0000-000000000032', tests.get_supabase_uid('limit_user1'), '70000000-0000-0000-0000-000000000001', 'spot 6 premium', 35.6, 139.6, true)
$$, 'premium can insert beyond 5');
reset role;

select is(
  (select count(*) from public.user_spots where map_id = '70000000-0000-0000-0000-000000000001')::bigint,
  6::bigint,
  'spot count becomes 6 after premium insert'
);
