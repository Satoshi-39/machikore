-- ============================================================
-- 検索RPC関数にページネーション（OFFSET）パラメータを追加
-- search_public_maps, search_public_spots, search_users
-- ============================================================

-- ============================================================
-- 1. search_public_maps に result_offset パラメータ追加
-- ============================================================

DROP FUNCTION IF EXISTS "public"."search_public_maps"("text", integer, "uuid"[], "text", "text", "text", "uuid");
...
COMMENT ON FUNCTION "public"."search_public_maps" IS '公開マップ検索。フィルター: タグ、期間、地域テキスト、ブロックユーザー除外。並び替え: created_at / likes_count。ページネーション対応。';
...
-- ============================================================
-- 2. search_public_spots に result_offset パラメータ追加
-- ============================================================

DROP FUNCTION IF EXISTS "public"."search_public_spots"("text", integer, "text", "text", "uuid"[], "text", "text", "uuid");
...
COMMENT ON FUNCTION "public"."search_public_spots" IS '公開スポット検索。フィルター: 都道府県、市区町村、タグ、期間、ブロックユーザー除外。並び替え: created_at / likes_count。ページネーション対応。';
...
-- ============================================================
-- 3. search_users に result_offset パラメータ追加
-- ============================================================

DROP FUNCTION IF EXISTS "public"."search_users"("text", integer, "uuid");
...
COMMENT ON FUNCTION "public"."search_users" IS 'ユーザー検索。ブロック済みユーザー除外。ページネーション対応。';

GRANT ALL ON FUNCTION "public"."search_users"("text", integer, "uuid", integer) TO "anon";
GRANT ALL ON FUNCTION "public"."search_users"("text", integer, "uuid", integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_users"("text", integer, "uuid", integer) TO "service_role";
