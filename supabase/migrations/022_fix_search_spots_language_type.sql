-- user_spots.language を varchar(10) → text に変更
-- search_public_spots を再作成してDB上の不要なキャストを除去

ALTER TABLE user_spots ALTER COLUMN language TYPE text;

-- search_public_spots を再作成（us.language::text キャストを除去）
