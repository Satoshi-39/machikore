-- RPC関数にavatar_crop関連フィールドを追加
-- ユーザーアバターの非破壊クロップ表示に対応
--
-- 対象:
-- 1. mixed_feed_item composite type: map_user_avatar_crop, spot_user_avatar_crop
-- 2. generate_feed_ad_slots: 新フィールド分のNULL追加
-- 3. get_mixed_feed: 新フィールドをSELECT
-- 4. get_following_mixed_feed: 新フィールドをSELECT
-- 5. search_public_maps: user_avatar_crop追加
-- 6. search_public_spots: user_avatar_crop追加

-- ============================================================
-- 0. RETURNS TABLEが変わる関数は先にDROPが必要
-- ============================================================
...
-- ============================================================
-- 1. mixed_feed_item composite type に2属性を追加
-- ============================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE t.typname = 'mixed_feed_item' AND a.attname = 'map_user_avatar_crop'
  ) THEN
    ALTER TYPE "public"."mixed_feed_item" ADD ATTRIBUTE "map_user_avatar_crop" jsonb;
    ALTER TYPE "public"."mixed_feed_item" ADD ATTRIBUTE "spot_user_avatar_crop" jsonb;
  END IF;
END $$;
...
-- ============================================================
-- 3. get_following_mixed_feed: avatar_cropフィールドをSELECT
-- ============================================================
...
-- ============================================================
-- 4. get_mixed_feed: avatar_cropフィールドをSELECT
-- ============================================================
...
GRANT ALL ON FUNCTION "public"."generate_feed_ad_slots"(integer, integer) TO "anon";
GRANT ALL ON FUNCTION "public"."generate_feed_ad_slots"(integer, integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_feed_ad_slots"(integer, integer) TO "service_role";

GRANT ALL ON FUNCTION "public"."get_mixed_feed"(integer, integer, timestamp with time zone, timestamp with time zone, "uuid", boolean, integer, boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."get_mixed_feed"(integer, integer, timestamp with time zone, timestamp with time zone, "uuid", boolean, integer, boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_mixed_feed"(integer, integer, timestamp with time zone, timestamp with time zone, "uuid", boolean, integer, boolean) TO "service_role";

GRANT ALL ON FUNCTION "public"."get_following_mixed_feed"("uuid", integer, integer, timestamp with time zone, timestamp with time zone, boolean, integer, boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."get_following_mixed_feed"("uuid", integer, integer, timestamp with time zone, timestamp with time zone, boolean, integer, boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_following_mixed_feed"("uuid", integer, integer, timestamp with time zone, timestamp with time zone, boolean, integer, boolean) TO "service_role";

GRANT ALL ON FUNCTION "public"."search_public_maps"("text", integer, "uuid"[], "text", "text", "text") TO "anon";
GRANT ALL ON FUNCTION "public"."search_public_maps"("text", integer, "uuid"[], "text", "text", "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_public_maps"("text", integer, "uuid"[], "text", "text", "text") TO "service_role";

GRANT ALL ON FUNCTION "public"."search_public_spots"("text", integer, "text", "text", "uuid"[], "text", "text") TO "anon";
GRANT ALL ON FUNCTION "public"."search_public_spots"("text", integer, "text", "text", "uuid"[], "text", "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_public_spots"("text", integer, "text", "text", "uuid"[], "text", "text") TO "service_role";
