...
-- 混合フィードにスポットタグを追加
-- ============================================================
-- spot_tags フィールドを追加して、スポットのタグ情報を返すように修正
-- 最終更新: 2026-01-18
...
COMMENT ON FUNCTION public.get_mixed_feed IS '混合フィード取得（マップ+スポット、cursor方式ページネーション対応）- spot_tags追加';
...
COMMENT ON FUNCTION public.get_following_mixed_feed IS 'フォロー中ユーザーの混合フィード取得 - spot_tags追加';
