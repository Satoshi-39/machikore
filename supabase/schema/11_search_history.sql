-- ============================================================
-- 検索履歴（search_history, search_analytics）
-- ============================================================
-- ユーザーの検索履歴をクラウドに保存 + 匿名分析データ
-- 最終更新: 2025-12-27

-- ============================================================
-- search_history（検索履歴 - ユーザー表示用）
-- ============================================================
...
-- RLS（分析データは匿名、管理者のみアクセス）
ALTER TABLE public.search_analytics ENABLE ROW LEVEL SECURITY;

-- ============================================================
-- 検索履歴を追加する関数（ユーザー用 + 分析用）
-- ============================================================
