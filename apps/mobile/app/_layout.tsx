...
import { SharedMapViewContainer } from '@/widgets/shared-map-view';
...
function AppContent() {
  ...
  return (
    <PortalProvider>
      ...
      {/* Stackの外側、PortalProviderの内側にシングルトンMapViewを配置 */}
      {/* pointerEvents="none"でPortalView（ソース側）のhitTestを無効化。
          MapViewはPortalHostView（宛先側）経由でタッチを受け取る。 */}
