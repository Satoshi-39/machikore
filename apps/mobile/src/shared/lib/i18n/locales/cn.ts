...
export default {
  ...
  onboarding: {
    ...
    categories: {
      title: '喜欢的分类',
      description: '选择您感兴趣的分类（可选）',
      maxSelection: '最多可选择{{max}}个',
    },
    completion: {
      title: '设置完成！',
      subtitle: '欢迎来到街コレ！\n发现您喜欢的地点，创建属于自己的地图。',
  ...
  spot: {
    ...
    deleteSpot: '删除地点',
    spotName: '地点名称',
    spotNamePlaceholder: '例：我最喜欢的咖啡厅',
    spotNameHint: '请输入这个地点的名称',
    spotNameRequired: '请输入地点名称',
    spotMemo: '备注',
    visitDate: '访问日期',
    visited: '已访问',
    notVisited: '未访问',
  ...
  profile: {
    ...
    region: '地区',
    interests: '兴趣爱好',
    interestsDescription: '最多可选择{{max}}个感兴趣的类别',
    usernameChangeWarning: '※更改用户名后，分享链接将失效',
  },
  ...
  settings: {
    ...
    searchLicenses: '搜索库',
    openSourceLicensesDescription: '本应用使用以下开源软件。点击可打开仓库页面。',
    // 数据来源
    attributions: '数据来源',
    attributionsDescription: '本服务使用以下数据来源。点击各项可查看详细信息。',
    mapData: '地图数据',
