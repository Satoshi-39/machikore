...
export default {
  ...
  insertMenu: {
    ...
    supportedServices: '対応: YouTube, X(Twitter), Instagram, その他のURL',
    embedButton: '埋め込む',
    invalidUrl: '無効なURL',
    invalidUrlMessage: '有効なURLを入力してください',
    insertMap: 'マップを挿入',
    insertMapDescription: '自分のマップをカードとして挿入',
    insertSpot: 'スポットを挿入',
    insertSpotDescription: '自分のスポットをカードとして挿入',
    selectMap: 'マップを選択',
    selectSpot: 'スポットを選択',
    noMaps: 'マップがありません',
    noMapsHint: 'マイページからマップを作成してください',
    noSpots: 'スポットがありません',
    noSpotsHint: 'このマップにスポットを追加してください',
    spotCount: '%{count}スポット',
  },
