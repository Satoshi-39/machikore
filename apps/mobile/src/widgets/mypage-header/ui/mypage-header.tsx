  ...
  return (
    <View className="bg-surface px-4 py-3 border-b border-outline flex-row items-center justify-center relative">
      ...
      <View className="absolute right-4 flex-row gap-2">
        ...
        >
          <Ionicons name="calendar-outline" size={iconSizeNum.lg} className="text-on-surface-variant" />
        </Pressable>
        */}
        ...
        <Pressable
          ...
          className="w-10 h-10 items-center justify-center rounded-full bg-secondary"
        >
          <Ionicons name="settings-outline" size={iconSizeNum.lg} className="text-on-surface-variant" />
        </Pressable>
      </View>
    </View>
  );
